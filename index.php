...
if(!empty($heroes)){
    ...
    if(isset($_GET['Companyid'])){
        ...
        $heroes = searchProperty($heroes,'companyId',$_GET['Companyid']);
    }
}
?>
...
<div style="margin-bottom: 1%" class="row">
    ...
    <div class="col-md-0">
        <div class="btn-group">
            ...
            <a href="index.php?Companyid=1" class="btn btn-dark text-light">Accion</a>
            <a href="index.php?Companyid=2" class="btn btn-dark text-light">Terror</a>
            <a href="index.php?Companyid=3" class="btn btn-dark text-light">Comedia</a>
            <a href="index.php?Companyid=4" class="btn btn-dark text-light">Suspenso</a>
            <a href="index.php?Companyid=5" class="btn btn-dark text-light">Documentales</a>
        </div>
    </div>
</div>
<div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="heroes/delete.php?id=<?= $hero['id']?>" class="btn btn-danger">Eliminar</a>
                    </div>
                </div>
